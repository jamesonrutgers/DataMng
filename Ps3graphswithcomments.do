...
scatter belowpov2 percBelowpov2, mlabel(county) 
graph hbar cases deaths percBelowpov2, over(county) //rework
//drop word county; clutter and redundant
// add more variables to explore research question, more research
